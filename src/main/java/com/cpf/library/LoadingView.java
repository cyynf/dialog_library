    ...
    public void upThrow() {
        ...
        switch (mShapeLoadingView.getShape()) {
            case SHAPE_RECT:
                ...
                mLoadTextView.setTextColor(getResources().getColor(R.color.triangle));
                break;
            case SHAPE_CIRCLE:
                objectAnimator1 = ObjectAnimator.ofFloat(mShapeLoadingView, "rotation", 0, 180);
                mLoadTextView.setTextColor(getResources().getColor(R.color.rect));
                break;
            case SHAPE_TRIANGLE:

                objectAnimator1 = ObjectAnimator.ofFloat(mShapeLoadingView, "rotation", 0, 180);
                mLoadTextView.setTextColor(getResources().getColor(R.color.circle));
                break;
        }
